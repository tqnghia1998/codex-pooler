...
const DICTIONARY = {
  en: {
    ...
    'tabQuotaRequests': 'Community requests',
    'tabMyQuotaRequests': 'My posted requests',
    'tabSentRequests': 'My share requests',
    'tabApprovals': 'Requests for my shares',
    'tabMyAccess': 'My access (Granted sessions)',
    'tabSharedByMe': 'Active shares granted',

    // Actions & Search
    'publishOffer': 'Share quota',
    'askForQuota': 'Post quota request',
    'broadcastQuotaRequest': 'Post request',
    ...
    'updateProjectKey': 'Update project key',
    ...
    'delayedQuotaRemaining': 'Delayed report: ${amount} remaining',
    'delayedQuotaUsage': 'Delayed report: ${used} used of ${limit}',
    'delayedQuotaNoData': 'No delayed quota data found for this month',
    ...
    'requestedQuotaToast': 'Requested ${amount} from this share',
    'requestedOnly': '${requested} requested',
    'ticketCancelled': 'Share request cancelled',
    'ticketRejected': 'Share request rejected',
    'ticketApproved': 'Share request approved',
    ...
    'quotaRequestPublished': 'Community request posted',
    'quotaRequestGranted': 'Quota granted to requester',
    'quotaRequestCancelled': 'Community request cancelled',
    ...
    'projectKeyRejected': 'Project key rejected',
    ...
    'communityRequestsTable': 'Community requests table',
    'shareRequestsTable': 'Share requests table',
    ...
    'emptyQuotaRequestsTitle': 'No community requests',
    'emptyQuotaRequestsDesc': 'Quota requests posted by members will appear here.',
    'emptyMyQuotaRequestsTitle': 'No posted requests',
    'emptyMyQuotaRequestsDesc': 'Quota requests you post for providers to grant will appear here.',
    'noUpstreamForOffers': 'Your Codex account has no available upstream.',
    'emptySentRequestsTitle': 'No share requests sent',
    'emptySentRequestsDesc': 'Requests you make for specific shares will appear here.',
    'emptyApprovalsTitle': 'No requests for your shares',
    'emptyApprovalsDesc': 'Requests for shares you published will appear here for approval.',
    'emptyMyAccessTitle': 'No shared access',
    'emptyMyAccessDesc': 'Approved share requests and direct grants will create access here.',
    'emptySharedByMeTitle': 'No active shares',
    'emptySharedByMeDesc': 'Shares you approve or grant directly to other members will appear here.',
    ...
    'quotaRequestMessagePlaceholder': 'Please help, I need some quota for my tasks',
    ...
    // Ticket dialog
    'approveTicketTitle': 'Approve share request',
    ...
    'openAiApiBaseUrl': 'OpenAI-compatible API base URL',
    'anthropicApiBaseUrl': 'Anthropic API base URL',
    ...
    'adminActiveOffers': 'Active share records',
    'adminActiveSessions': 'Active or paused sessions',
    'adminPendingApprovals': 'Pending share requests',
    'adminOpenRequests': 'Open community requests',
    'accountCol': 'Account',
    ...
    'adminToday': 'Today',
    'adminRequests': 'Session requests',
    'adminSuccessRate': 'Success rate',
    'adminRequestFunnel': 'Share request funnel',
    'adminTotalRequests': 'Total share requests',
    'adminApproved': 'Approved',
    'adminRejected': 'Rejected',
    'adminApprovalRate': 'Reviewed approval rate',
    'adminProviderHealth': 'Provider health',
    'adminSharingSessions': 'Sharing sessions',
    'adminSharingFrom': 'Sharing from',
    'adminSharingTo': 'Shared with',
    'adminQuotaLeftTotal': 'Left / total',
    'adminNoSessions': 'No sharing sessions yet.',
    ...
    'adminBackupLast': 'Last automatic backup: {time}',
    'adminBackupPending': 'No automatic backup has completed yet.',
    'adminBackupDisabled': 'Automatic backup is not configured.',
    ...
    'adminAsOf': 'Updated {time}',
    'adminMetricScope': 'Usage covers retained share sessions. Share request metrics exclude direct grants; community requests are counted separately.',
    'adminTodayUtc': 'Today (UTC)',
    'adminProviderType': 'Provider',
    'adminStatus': 'Status',
    'adminShares': 'Shares',
    'adminObserved': 'Observed',
    'adminNotObserved': 'Not observed',
    'adminHealthy': 'Sharing active',
    'adminPaused': 'Paused',
    'adminProviderUnavailable': 'Provider unavailable',
    'adminProviderReauth': 'Sign-in required',
    'adminProjectKeyRejected': 'Project key rejected',
    'adminProviderRefreshFailed': 'Token refresh failed',
    'adminProviderExhausted': 'Quota exhausted',
    'adminEmailPending': 'Queued emails',
    'adminEmailFailed': 'Failed emails',
    'adminEmailDelivery': 'Email delivery',
    'adminEmailState': 'Notifications',
    'adminEnabled': 'Enabled',
    'adminDisabled': 'Disabled',
    'adminOldestPending': 'Oldest queued',
    'adminNextAttempt': 'Next attempt',
    'adminNone': 'None',
    'adminNoProviders': 'No providers are linked.',
    'adminDailyUsage': 'Daily session usage',
    'adminUsageWindow': 'Usage period',
    'adminSevenDays': '7 days',
    'adminThirtyDays': '30 days',
    'adminAll': 'All',
    'adminUsageTrackingNote': 'Daily tracking starts with this version; earlier usage cannot be reconstructed. Dates are UTC.',
    'adminUsageEmpty': 'No session requests recorded in this period.',
    'adminSuccesses': 'Successful',
    'adminFailures': 'Failed',
    'adminEntity': 'Entity ID',
    'adminSearchEvents': 'Search activity',
    'adminSearch': 'Search',
    'adminActivityWindow': 'Activity period',
    'adminBackupFailed': 'Automatic backup failed at {time}',
    'adminExportSensitive': 'Exports contain sensitive account and credential data. Store them securely.',
    'adminImportExportedAt': 'Exported {time}',
    'adminImportGatewayCount': 'Gateway records: {count}',
    'adminImportType': 'Type IMPORT to replace the listed collections'
  },
  zh: {
    'communityActivity': '社区动态',
    'communityRequests': '社区额度需求',
    'communityOffers': '共享',
    'communityHelp': '去帮帮他们！',
    ...
    'tabMyOffers': '我的共享额度',
    'tabQuotaRequests': '社区额度需求',
    'tabMyQuotaRequests': '我发布的额度需求',
    'tabSentRequests': '我发出的共享申请',
    'tabApprovals': '申请我的共享',
    'tabMyAccess': '我的可用额度',
    ...
    'delayedQuotaRemaining': '延迟数据：剩余 ${amount}',
    'delayedQuotaUsage': '延迟数据：已用 ${used} / ${limit}',
    'delayedQuotaNoData': '本月未找到延迟额度数据',
    ...
    'sharingPaused': '已暂停共享',
    'requestedQuotaToast': '已向此共享申请 ${amount} 额度',
    'requestedOnly': '已申请 ${requested}',
    'ticketCancelled': '共享申请已取消',
    'ticketRejected': '共享申请已拒绝',
    'ticketApproved': '共享申请已批准',
    ...
    'quotaRequestPublished': '社区额度需求已发布',
    'quotaRequestGranted': '已为需求方授予额度',
    'quotaRequestCancelled': '社区额度需求已取消',
    ...
    'emptyQuotaRequestsTitle': '暂无社区额度需求',
    'emptyQuotaRequestsDesc': '成员发布的额度需求将显示在此处。',
    'emptyMyQuotaRequestsTitle': '尚未发布额度需求',
    'emptyMyQuotaRequestsDesc': '您发布供提供方直接授予的额度需求将显示在此处。',
    'noUpstreamForOffers': '您的 Codex 账户暂无可用渠道。',
    'emptySentRequestsTitle': '暂无发出的共享申请',
    'emptySentRequestsDesc': '您针对具体共享发出的申请将显示在此处。',
    'emptyApprovalsTitle': '暂无申请您的共享',
    'emptyApprovalsDesc': '成员申请您发布的共享后，您可在此审批。',
    'emptyMyAccessTitle': '暂无可用额度会话',
    'emptyMyAccessDesc': '审批通过的共享申请或直接授予将为您创建可用会话。',
    'emptySharedByMeTitle': '暂无已授权共享',
    'emptySharedByMeDesc': '您批准的共享申请或直接授予的共享会话将显示在此处。',
    ...
    'neededQuotaUsd': '所需额度（美元）',
    'requester': '需求方',
    'needed': '所需',
    'offerMessage': '留言',
    'offerMessageHelp': '可选，所有能查看此共享的成员都会看到这条留言。',
    'offerMessagePlaceholder': '这里有一些闲置额度，欢迎申请。',
    'quotaRequestMessagePlaceholder': '请帮帮我，我需要一些额度来完成任务',
    'noOfferMessage': '无留言',
    'expiresOn': '有效期至',
    ...
    'quotaRequestWhitelistHelp': '以逗号或换行分隔提供方邮箱，只有名单中的提供方可以看到该需求。',
    'visibilityBadgePublic': '公开',
    'visibilityBadgeRestricted': '白名单 ({count}人)',
    'historicalOfferBadge': '授予记录',
    'closeOfferConfirmTitle': '关闭历史共享？',
    ...
    'apiKey': 'API 密钥',
    'apiBaseUrl': 'API 基础地址',
    'openAiApiBaseUrl': 'OpenAI 兼容 API 基础地址',
    'anthropicApiBaseUrl': 'Anthropic API 基础地址',
    ...
    'adminActiveOffers': '生效中共享记录',
    'adminActiveSessions': '运行或暂停的会话',
    'adminPendingApprovals': '待审批共享申请',
    'adminOpenRequests': '未完成的社区额度需求',
    'accountCol': '账户',
    'sessionsCol': '会话数',
    'whenCol': '时间',
    'actorCol': '操作人',
    ...
    'adminToday': '今日消耗',
    'adminRequests': '共享会话请求数',
    'adminSuccessRate': '请求成功率',
    'adminRequestFunnel': '共享申请漏斗',
    'adminTotalRequests': '共享申请总数',
    'adminApproved': '已批准',
    'adminRejected': '已拒绝',
    'adminApprovalRate': '已审核通过率',
    'adminProviderHealth': '提供方健康度',
    'adminSharingSessions': '共享会话',
    'adminSharingFrom': '共享方',
    'adminSharingTo': '接收方',
    'adminQuotaLeftTotal': '剩余 / 总额度',
    'adminNoSessions': '暂无共享会话。',
    ...
    'adminBackupLast': '上次自动备份：{time}',
    'adminBackupPending': '尚未完成自动备份。',
    'adminBackupDisabled': '尚未配置自动备份。',
    'adminExport': '导出数据',
    ...
    'adminOverview': '概览',
    'adminOperations': '运行状况',
    'adminActivity': '动态',
    'adminAsOf': '更新于 {time}',
    'adminMetricScope': '用量仅包含保留中的共享会话。共享申请指标不含直接授予；社区额度需求单独统计。',
    'adminTodayUtc': '今日（UTC）',
    'adminProviderType': '提供方',
    'adminStatus': '状态',
    'adminShares': '共享数',
    'adminObserved': '观测时间',
    'adminNotObserved': '尚未观测',
    'adminHealthy': '共享中',
    'adminPaused': '已暂停',
    'adminProviderUnavailable': '提供方不可用',
    'adminProviderReauth': '需要重新登录',
    'adminProjectKeyRejected': '项目密钥被拒绝',
    'adminProviderRefreshFailed': '令牌刷新失败',
    'adminProviderExhausted': '额度已耗尽',
    'adminEmailPending': '待发送邮件',
    'adminEmailFailed': '发送失败邮件',
    'adminEmailDelivery': '邮件发送',
    'adminEmailState': '通知状态',
    'adminEnabled': '已启用',
    'adminDisabled': '已停用',
    'adminOldestPending': '最早待发送',
    'adminNextAttempt': '下次尝试',
    'adminNone': '无',
    'adminNoProviders': '暂无绑定的提供方。',
    'adminDailyUsage': '每日共享会话用量',
    'adminUsageWindow': '用量区间',
    'adminSevenDays': '7 天',
    'adminThirtyDays': '30 天',
    'adminAll': '全部',
    'adminUsageTrackingNote': '每日统计从此版本开始记录，无法还原此前的每日用量。日期均为 UTC。',
    'adminUsageEmpty': '此期间尚无共享会话请求。',
    'adminSuccesses': '成功',
    'adminFailures': '失败',
    'adminEntity': '实体 ID',
    'adminSearchEvents': '搜索动态',
    'adminSearch': '搜索',
    'adminActivityWindow': '动态区间',
    'adminBackupFailed': '自动备份于 {time} 失败',
    'adminExportSensitive': '导出文件包含敏感账户和凭据数据，请妥善保管。',
    'adminImportExportedAt': '导出时间：{time}',
    'adminImportGatewayCount': '网关记录：{count}',
    'adminImportType': '输入 IMPORT 以替换所列数据'
  }
};
