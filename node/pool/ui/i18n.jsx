...
const DICTIONARY = {
  en: {
    ...
    'tabLeaderboard': 'Top Providers',
    'leaderboardSubtitle': 'Top providers by settled quota usage.',
    'leaderboardLoading': 'Loading leaderboard',
    'leaderboardUnavailableTitle': 'Leaderboard unavailable',
    'leaderboardUnavailableDesc': 'Unable to load the community leaderboard.',
    'leaderboardTopProviders': 'Top providers',
    'leaderboardTopConsumers': 'Top consumers',
    'leaderboardProvidersEmpty': 'Settled provider usage will appear here.',
    'leaderboardConsumersEmpty': 'Settled consumer usage will appear here.',
    ...
    'adminMetricScope': 'Usage covers retained share sessions. The request funnel covers share applications only; direct grants are not included.',
  ...
  zh: {
    ...
    'tabLeaderboard': '提供方排行',
    'leaderboardSubtitle': '按已结算额度用量统计的提供方排行。',
    'leaderboardLoading': '正在加载排行榜',
    'leaderboardUnavailableTitle': '排行榜不可用',
    'leaderboardUnavailableDesc': '无法加载社区排行榜。',
    'leaderboardTopProviders': '提供方排行',
    'leaderboardTopConsumers': '使用方排行',
    'leaderboardProvidersEmpty': '提供方的已结算使用量将显示在此处。',
    'leaderboardConsumersEmpty': '使用方的已结算使用量将显示在此处。',
    'leaderboardRank': '排名',
    ...
    'quotaRequestPublished': '额度需求已发布',
    'quotaRequestGranted': '额度需求已授予',
    'quotaRequestCancelled': '额度需求已取消',
    ...
    'adminActivity': '动态',
    'adminAsOf': '更新于 {time}',
    'adminMetricScope': '用量仅包含保留中的共享会话。申请漏斗仅统计共享申请，不包含直接授予。',
