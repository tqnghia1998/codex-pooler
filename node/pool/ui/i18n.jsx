...
const DICTIONARY = {
  en: {
    ...
    'shareProvidersDesc': 'Codex quota refreshes automatically; Claude and AIS show delayed advisory data when available.',
  ...
  zh: {
    ...
    'shareProvidersDesc': 'Codex 额度自动刷新；Claude 与 AIS 在可用时显示延迟参考数据。',
    'linkCodex': '绑定 Codex',
