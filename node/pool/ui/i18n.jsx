...
const DICTIONARY = {
  en: {
    ...
    'shareProvidersDesc': 'Codex quota refreshes automatically; Claude and AIS quotas are managed externally.',
  ...
  zh: {
    ...
    'shareProvidersDesc': 'Codex 额度自动刷新；Claude 与 AIS 额度在外部系统管理。',
    'linkCodex': '绑定 Codex',
