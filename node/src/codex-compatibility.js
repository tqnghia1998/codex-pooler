...
const CONTINUITY_ALIAS_SESSION_NAMESPACE = Buffer.from('60a80f243dd35aebbe7726ea7c41d36f', 'hex');
...
export function promptCacheSessionId(scope = {}, key) {
  return scopedSessionId(PROMPT_CACHE_SESSION_NAMESPACE, scope, key);
}

export function continuityAliasSessionId(scope = {}, key) {
  return scopedSessionId(CONTINUITY_ALIAS_SESSION_NAMESPACE, scope, key);
}

function scopedSessionId(namespace, { scopeId, apiKeyId }, key) {
